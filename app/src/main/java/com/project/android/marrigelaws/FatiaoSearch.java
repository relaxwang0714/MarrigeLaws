...
/**
 * Created by 13zqn on 2017/7/24.
 */

public class FatiaoSearch extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fatiao_search);
//        initData();
//        initViews();
        ...
        etInput.setOnKeyListener(new View.OnKeyListener(){
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER&& event.getAction() == KeyEvent.ACTION_DOWN){
                    ...
                    intent.setClass(FatiaoSearch.this,FatiaoCheck.class);
                    FatiaoSearch.this.startActivity(intent);
                }
                return false;
            }
        });
...
//                Toast.makeText(FatiaoSearch.this, position + "", Toast.LENGTH_SHORT).show();
//            }
//        });
//    }
