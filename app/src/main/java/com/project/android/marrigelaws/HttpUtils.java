...
import com.project.android.marrigelaws.bean.ChatMessage;
import com.project.android.marrigelaws.bean.ChatMessage.Type;
import com.project.android.marrigelaws.bean.CommonException;
import com.project.android.marrigelaws.bean.Result;
...
{
	private static String API_KEY = "bc024a07f1884b31840a0869413ec4d2";
